    ...
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>Embark on a transformative educational journey with our university's comprehensive education programs. our cutting-edge 
                cirriculum is designed to empower students with the knowledge, 
            ...
            <p>Whether you aspire to become a teacher, administrator, counselor, or educational leader, 
                our diverse range f programs offers the perfect pathway to achieve your goals
                and unlock the potential in shaping the future of education.</p>
        </div>
    </div>
  )
}
